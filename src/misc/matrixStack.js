...
class MStack {
     ...
     */
    constructor() { this.stack = [mat4.identity(mat4.create())]; this.saved = null; }
     ...
     */
    push() { this.stack.push(this.getMatrix()); }

    /**
     * @returns the top of the stack
     */
    getMatrix() { return this.stack[this.stack.length - 1].slice(); }

    /**
     * @param {mat4} m matrix to set the top of the stack to
     */
    setMatrix(m) { this.stack[this.stack.length - 1] = m; }
     ...
     */
    translate(coord) { this.setMatrix(mat4.translate(this.getMatrix(), coord)); }
     ...
     */
    rotate(axis, degree) { this.setMatrix(mat4.rotate(this.getMatrix(), degree/180.0*3.1415, axis)); }
     ...
     */
    rotateX(degree) { this.rotate([1,0,0], degree); }
     ...
     * @param {int} degree degrees tp rotate by
     */
    rotateY(degree) { this.rotate([0,1,0], degree); }
     ...
     * @param {int} degree degrees tp rotate by
     */
    rotateZ(degree) { this.rotate([0,0,1], degree); }
